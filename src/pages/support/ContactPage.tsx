                  ...
                  <div className="space-y-4">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <a href="mailto:youvegottabefreakingkiddingme@gmail.com" className="text-sm text-muted-foreground hover:text-primary">
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          I don't have an office yet, but I hope to have one soon!
                        </p>
                      </div>
                    </div>
