              ...
              <div className="lg:col-span-3 relative overflow-hidden rounded-xl">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex flex-col justify-end p-8">
                  ...
                  <h2 className="text-2xl md:text-3xl font-bold text-white mb-3">
                    Behind the Scenes: How We Built Book-Kreate's AI Engine
                  </h2>
                  <p className="text-white/90 mb-4 line-clamp-2">
                    An inside look at the technology and innovation that powers our AI book creation platform, and our vision for the future of AI-assisted writing.
                  </p>
