        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          <div className="lg:w-1/2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 mb-10">
              {features.map((feature, index) => (
                <div key={index} className="flex items-center">
                  <CheckCircle size={20} className="text-white mr-2 flex-shrink-0" />
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link to="/auth">
                <Button className="bg-white text-book-purple hover:bg-white/90 text-base font-medium h-12 px-8 shadow-lg hover:shadow-xl transition-all duration-300">
                  Get Started Free
                  <ArrowRight size={18} className="ml-2" />
                </Button>
              </Link>
              <Link to="/about">
                <Button variant="outline" className="text-white border-white hover:bg-white/10 text-base font-medium h-12 px-8">
